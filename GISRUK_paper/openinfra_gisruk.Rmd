...
To examine the potential of OSM for active travel research, exploratory data analysis (EDA) was used.


Data was queried using `osmextract` package [@Gilardi_Lovelace2021] using R. Three areas were chosen as case studies (for data sizes see Table 1): 
...
Reproducible code can be found in Open Infra GitHub repository: https://github.com/udsleeds/openinfra
...
Greta is a data science intern at the University of Leeds.
