...
download.file(url, 
              destfile = "leeds_central.RDS",
              mode = "wb") # downloading the file to the working directory; if you do not know where your working directory is, type `getwd()` to your console.

leeds_central = readRDS("leeds_central.RDS",
                        mode = "wb") # reading the file
```
