...
mapview::mapshot(pretty_map, file = paste0(getwd(), "/pretty_map.pdf")
                 )

htmlwidgets::saveWidget(pretty_map@map,
                        file = paste0(getwd(), "/pretty_map.html"),
                        selfcontained = FALSE)
...
mapview::mapview(leeds_foot_tidy) # plot
dev.off() # closes the file
```
