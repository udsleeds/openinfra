...
download.file(url1,
              destfile = "leeds_net_walking.RDS")
leeds_net_walking = readRDS("leeds_net_walking.RDS")
...
```{r, results = "hide"}
url4 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds_central_14-02-2022.RDS"
download.file(url4, 
              destfile = "leeds_central_14-02-2022.RDS") # downloading the file to the working directory; if you do not know where your working directory is, type `getwd()` to your console.

leeds_central = readRDS("leeds_central_14-02-2022.RDS") # reading the file
```
