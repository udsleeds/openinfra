...
leeds_net_walking_manual = leeds_tn %>% 
  ...
  filter(highway != "cycleway" | foot %in% c('yes', 'designated', 'permissive', 'destination')) %>% # do not return rows if highway=='cycleway' unless foot == 'yes' 
