...
In this section we will focus on two aspects necessary to work with OpenStreetMap (OSM) data for transport research:
...
# Convert .RDS to .geojson and upload
# test with:
url1 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds_net_walking.RDS"
url2 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds.RDS"
url3 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds_tn.RDS"
url4 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds_central.RDS"

rds_to_json = function(u) {
  u_geojson = gsub(pattern = ".RDS|.Rds", replacement = ".geojson", x = u)
  f_geojson = basename(u_geojson)
  sf_object = readRDS(url(u))
  sf::write_sf(sf_object, f_geojson)
  piggyback::pb_upload(f_geojson)
  piggyback::pb_download_url(f_geojson)
}
rds_to_json(url1)
rds_to_json(url2)
rds_to_json(url3)
...
```{r, results = "hide"}
url4 = "https://github.com/udsleeds/openinfra/releases/download/v0.1/leeds_central.geojson"
leeds_central = sf::read_sf(url4) # reading the file
```
