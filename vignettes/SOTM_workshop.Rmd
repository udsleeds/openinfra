...
![plot output](https://user-images.githubusercontent.com/58815827/185735455-78849abc-ec98-4597-b079-b3874008ebf9.png)
...
The `oi_active_cycle` and `oi_active_walk` functions recategorises OSM infrastructure data based on whether or not the feature in question forms part of a usable transport network for cyclists or pedestrians.
