...
knitr::include_url("https://udsleeds.github.io/openinfraresults/LADs_UK_NI_1.html", height = "850px")
```
...
```
```{r, echo=FALSE, include=TRUE, out.width="900px"}
knitr::include_url("https://udsleeds.github.io/openinfraresults/LADs_UK_NI_region_coloured_2.html", height = "1500px")
```
<br><br>
...
```
```{r, echo=FALSE, include=TRUE, out.width="900px"}
knitr::include_url("https://udsleeds.github.io/openinfraresults/England_transport_regions_3.html", height = "850px")
```
...
```
```{r, echo=FALSE, include=TRUE, out.width="900px"}
knitr::include_url("https://udsleeds.github.io/openinfraresults/Coloured_England_transport_regions_4.html", height = "1500px") 
```
