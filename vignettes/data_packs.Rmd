...
# Current Data Pack Example

A current exmaple data pack for "Leeds" - contains outputs: 
- Active cycle network
- Active walking network
- Presence of lighting network
- Cleaned maximum speed values
- Cleaned road descriptions
- Inclusive Mobility (unfortunately not mapped here due to filesize)
