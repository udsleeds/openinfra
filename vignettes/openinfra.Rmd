...
The most important tag for transport research is `highway` as it indicates the type of road. Table 1 shows a list of highway values to work with.
...
highway_table = data.frame("Highway" = c("cycleway",
                           ...
                           Meaning = c("Pats for cycling",
                                       ...
                                       "Service roads for access to buildings, parking lots, gas station, etc.",
