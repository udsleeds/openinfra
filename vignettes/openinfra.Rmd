...
```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", fig.cap="Figure 1. Note: no highways in central Leeds have width tagged."}
tmap::tmap_mode("view")
