...
u = "http://github.com/udsleeds/openinfra/releases/download/v0.1/bicyle_parking_points.Rds"
# see function in osmintro.Rmd
rds_to_json(u)
```

```{r, title = "bicycle rental", out.width="100%", echo=FALSE, message=FALSE, warning=FALSE}
u = "http://github.com/udsleeds/openinfra/releases/download/v0.1/bicyle_parking_points.geojson"
bicycle_parking_points = sf::read_sf(u)
tmap::tmap_mode("view")
