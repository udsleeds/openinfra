...
OpenInfra is a 12 month project, thus its actual impact is yet to be determined. Nevertheless, the project has already contributed to the empirical examination of OSM data, which has resulted in the accepted [extended abstract](http://liverpool.gisruk.org/conference-programme/). One of the key contributions of the project has been the consideration of OSM data from the perspective of *accessibility*, a central characteristic in designing cycling and pedestrian infrastructures [@ltn1/20, @inclusive_mobility_dft_2021] (reference LTN1/20 and IM). 
