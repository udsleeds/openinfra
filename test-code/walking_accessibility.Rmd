...
wy_walking_nogeom1 %>% filter(pedestrian == "yes" | pedestrian == "maybe" | pedestrian == "no") %>% nrow() # 181302 rows that had been recoded
...
wy_walking_nogeom1 %>% filter(pedestrian == "yes") %>% nrow
wy_walking_nogeom2 %>% filter(pedestrian == "yes") %>% nrow
...
```{r}
sf_col_table(wy_walking_nogeom1, "footway")
# .
...
wy_walking_nogeom3 %>% filter(highway %in% highway_pedestrian_maybe & 
      foot %in% foot_pedestrian_no  | 
      footway %in% footway_pedestrian_no)

wy_walking_nogeom2 %>% filter(pedestrian == "yes") %>% nrow
wy_walking_nogeom2 %>% filter(pedestrian == "maybe") %>% nrow 
wy_walking_nogeom3 %>% filter(pedestrian == "yes") %>% nrow
wy_walking_nogeom3 %>% filter(pedestrian == "maybe") %>% nrow
wy_walking_nogeom2 %>% filter(pedestrian == "no") %>% nrow
wy_walking_nogeom3 %>% filter(pedestrian == "no") %>% nrow
```

```{r}
wy_walking_nogeom2 %>% filter(highway %in% highway_pedestrian_maybe & footway %in% footway_pedestrian_yes )
```

```{r}
sf_col_table(wy_walking_nogeom2, "sidewalk")
# .
...
wy_walking_nogeom3 <- wy_walking_nogeom2 %>% 
  mutate(pedestrian = case_when(
    # highway=*
    highway %in% highway_pedestrian_yes ~ "yes",
    highway %in% highway_pedestrian_maybe ~ "maybe",
    ...
    highway %in% highway_pedestrian_maybe & footway %in% footway_pedestrian_no ~ "no",
    # sidewalk
    highway %in% highway_pedestrian_maybe & sidewalk %in% sidewalk_pedestrian_yes ~ "yes",
    highway %in% highway_pedestrian_maybe & sidewalk %in% sidewalk_pedestrian_no ~ "no"

         )
         )


wy_walking_nogeom_test <- wy_walking_nogeom %>% 
  mutate(pedestrian = case_when(
    highway %in% highway_pedestrian_yes ~ "yes",
    highway %in% highway_pedestrian_no ~ "no",
    ...
    highway %in% highway_pedestrian_maybe & 
      foot %in% foot_pedestrian_yes | 
      footway %in% footway_pedestrian_yes | 
      sidewalk %in% sidewalk_pedestrian_yes ~ "yes",
    
    highway %in% highway_pedestrian_maybe & 
      foot %in% foot_pedestrian_no  | 
      footway %in% footway_pedestrian_no | 
      sidewalk %in% sidewalk_pedestrian_no ~ "no"
  )
  )


wy_walking_nogeom_test %>% filter(pedestrian == "yes") %>% nrow()
wy_walking_nogeom %>% filter(pedestrian == "yes") %>% nrow()
```

```{r}
wy_walking_nogeom2 %>% filter(highway %in% highway_pedestrian_maybe & sidewalk %in% sidewalk_pedestrian_yes)
