...
**cycleway|cycleway_left|cycleway_right|cycleway_both = ["track"](https://wiki.openstreetmap.org/wiki/Tag:cycleway%3Dtrack)** 
...
**highway = ["cycleway"](https://wiki.openstreetmap.org/wiki/Tag:highway%3Dcycleway)**
<br><br>The highway=cycleway tag indicates a **separate** (thus segregated) way for the use of cyclists.

#### Ignore Tags

**cycleway|cycleway_left|cycleway_right|cycleway_both = ["seperate"](https://wiki.openstreetmap.org/wiki/Tag:cycleway%3Dseparate)** 
