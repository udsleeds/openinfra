...
What is an active travel mapathon? First things first, a mapathon is an organised and coordinated mapping activity during which we will be going out to Leeds city centre to collect and add data to [OpenStreetMap](https://www.openstreetmap.org/#map=14/53.8013/-1.5438) (OSM), a free and open-source project looking to create a geographical database of the entire planet. Active travel refers to walking, wheeling, and cycling as a mode of transportation. Thus, in this event we will be adding data that is essential for active travel infrastructure planning.
...
Prerequisites: We do not expect any prior knowledge of OpenStreetMap or mapping -- you will be introduced to all of the tips and tricks. However, we do expect you to have a working smartphone that supports either the [StreetComplete](https://github.com/streetcomplete/StreetComplete/#download) (Android) or [Go Map!!](https://itunes.apple.com/app/id592990211) (iOS) apps (internet required for both). Also, we will ask you to create an account with OpenStreetMap. The instructions will be sent before the start of the event.
...
If you have any questions, please contact Greta via email: [g.timaite\@warwick.ac.uk](mailto:g.timaite@warwick.ac.uk){.email}