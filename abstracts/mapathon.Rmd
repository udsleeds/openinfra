...
We, the Openinfra project team, believe that one way of addressing the aforementioned issue is to combine citizen science and open data sources. Our work focused on exploring the utility of OpenStreetMap as an open data-source for locally sourced evidence on active travel infrastructure, for which the Openinfra team were nominated finalists for the Leeds Digital Festival (LDF) 2022 [Sustainability Award](https://www.yorkshirepost.co.uk/business/leeds-digital-festival-awards-celebrate-regions-tech-talent-3866188), more project information can be found on our [GitHub](https://github.com/udsleeds/openinfra). As such, we want you to join us in creating more open-data about our local environment that could be used by policy makers, researchers, and you!
